...
public abstract class CajeroAutomatico  {
	...
	public void Operaciones() {
		...
		int opciones = 0;
			...
			do {
				do { 
					opciones = Integer.parseInt(JOptionPane.showInputDialog("Por favor seleccione una opción: \n"
					+" 1.Consultar Saldo \n"
					+" 2.Retirar Fondos \n"
				...
				/*	System.out.println("Por favor seleccione una opción: ");
					...
					*/
					...
					if (opciones >=1 && opciones <=4) {
						...
						JOptionPane.showMessageDialog(null, "La opción que eligio "+opciones+" no existe, por favor vuelva intentarlo de nuevo");
						
						/*System.out.println("---------------------------------------------------------------------------------");
						System.out.println("La opción que eligio "+opciones+" no existe, por favor vuelva intentarlo de nuevo");
						System.out.println("---------------------------------------------------------------------------------");
						*/
					}
